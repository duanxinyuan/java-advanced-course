...
### 8.2. java.io.Serializable、java.io.Externalizable
...
#### 13.7.2. SynchronizedList 和 Vector 的区别
...
### 15.15. <font color=blue>JVM 常量池</font>
...
### 15.17. <font color=blue>类加载机制</font>
...
## 16. <font color=blue>JAVA 锁</font>
...
### 16.18. AQS（AbstractQueuedSynchonizer）
...
### 17.4. Object 的等待/通知（wait/notify）机制
...
### 17.5. Thread.sleep()、Object.wait()、Condition.await()、LockSupport.park()的区别

#### 17.5.1. Thread.sleep()和 Object.wait()的区别
...
#### 17.5.4. Object.wait()和 LockSupport.park()的区别
...
### 18.2. AQS（AbstractQueuedSynchonizer）（见上文）

### 18.3. ReentrantLock（见上文）

### 18.4. ReentrantReadWriteLock
...
### 18.15. LinkedBlockingDeque（链式阻塞双端队列）

- 除了可以双端读写之外，其他方面与单向链式阻塞队列相同

### 18.16. ConcurrentLinkedQueue
...
### 18.17. ConcurrentLinkedDeque

- 除了可以双端读写之外，其他方面与 ConcurrentLinkedQueue 相同

### 18.18. DelayQueue（延迟队列）
...
### 18.19. PriorityBlockingQueue（具有优先级的阻塞队列）
...
#### 18.33.6. 线程池的 CAS、ReentrantLock
