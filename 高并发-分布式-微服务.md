...
- [<font color=red>高并发-分布式-微服务</font>](#font-colorred高并发-分布式-微服务font)
  - [<font color=blue>CAP</font>](#font-colorbluecapfont)
  - [<font color=blue>RPC</font>](#font-colorbluerpcfont)
  - [<font color=blue>分布式服务注册与发现</font>](#font-colorblue分布式服务注册与发现font)
  - [<font color=blue>分布式配置中心</font>](#font-colorblue分布式配置中心font)
  - [<font color=blue>分布式权限验证</font>](#font-colorblue分布式权限验证font)
  - [<font color=blue>分布式网关</font>](#font-colorblue分布式网关font)
  - [<font color=blue>分布式服务监控</font>](#font-colorblue分布式服务监控font)
  - [<font color=blue>分布式事务</font>](#font-colorblue分布式事务font)
  - [<font color=blue>分布式文件系统</font>](#font-colorblue分布式文件系统font)
  - [<font color=blue>Serverless</font>](#font-colorblueserverlessfont)
  - [<font color=blue>微服务定义</font>](#font-colorblue微服务定义font)
  - [<font color=blue>网络通信的发展</font>](#font-colorblue网络通信的发展font)
  - [<font color=blue>ServiceMesh</font>](#font-colorblueservicemeshfont)
  - [<font color=blue>Istio（服务网格路由）</font>](#font-colorblueistio服务网格路由font)
  ...
  - [<font color=blue>前端页面加速</font>](#font-colorblue前端页面加速font)
  - [<font color=blue>微服务治理策略</font>](#font-colorblue微服务治理策略font)
  - [<font color=blue>持续集成</font>](#font-colorblue持续集成font)
      - [Jenkins](#jenkins)
      - [Walle](#walle)

## <font color=blue>CAP</font>
...
## <font color=blue>分布式服务注册与发现</font>
...
## <font color=blue>分布式权限验证</font>

- Spring Security
- Apache Shiro

## <font color=blue>分布式网关</font>

- Spring Cloud Gateway
- Zuul

## <font color=blue>分布式服务监控</font>
...
## <font color=blue>Serverless</font>
...
## <font color=blue>ServiceMesh</font>
...
## <font color=blue>Istio（服务网格路由）</font>
...
## <font color=blue>Docker&Kubernetes（K8s）</font>
