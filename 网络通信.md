...
- [<font color=red>网络通信</font>](#font-colorred网络通信font)
  - [<font color=blue>网络通信模型</font>](#font-colorblue网络通信模型font)
      - [分层的作用](#分层的作用)
      - [Socket](#socket)
  - [<font color=blue>网络通信协议</font>](#font-colorblue网络通信协议font)
      - [TCP/IP](#tcpip)
          - [TCP 数据包大小](#tcp-数据包大小)
      ...
      - [HTTP](#http)
          ...
          - [HTTPS](#https)
          - [HTTP 码对照表](#http-码对照表)
          - [HTTP 的 GET 和 POST 的区别](#http-的-get-和-post-的区别)
  - [<font color=blue>网络路由</font>](#font-colorblue网络路由font)
      - [CDN](#cdn)
      - [DNS](#dns)
      - [正向代理、反向代理](#正向代理反向代理)
      - [LVS](#lvs)
      - [Nginx](#nginx)
      - [为什么混用 LVS 和 Nginx？](#为什么混用-lvs-和-nginx)
  - [<font color=blue>网络安全</font>](#font-colorblue网络安全font)
      - [注入攻击](#注入攻击)
      - [DDOS 攻击](#ddos-攻击)
      - [拖库、洗库、撞库](#拖库洗库撞库)
          - [拖库](#拖库)
  ...
  - [<font color=blue>Dubbo</font>](#font-colorbluedubbofont)
      - [Dubbo 层次结构](#dubbo-层次结构)
      - [Dubbo 工作原理](#dubbo-工作原理)
      - [Dubbo 服务的启动方式](#dubbo-服务的启动方式)
      - [Dubbo 的四种配置方式](#dubbo-的四种配置方式)
      - [Dubbo 的 Netty 同步调用模式实现原理](#dubbo-的-netty-同步调用模式实现原理)
      - [通信协议](#通信协议)
      - [序列化协议](#序列化协议)
      - [Dubbo 负载均衡策略](#dubbo-负载均衡策略)
      - [Dubbo 集群容错策略](#dubbo-集群容错策略)
      - [Dubbo 的 SPI](#dubbo-的-spi)
      - [Dubbo 动态代理策略](#dubbo-动态代理策略)
      - [Dubbo 服务治理](#dubbo-服务治理)
      - [Dubbo 服务降级](#dubbo-服务降级)
      - [Dubbo 的 RpcContext 是怎么传递的？](#dubbo-的-rpccontext-是怎么传递的)
      - [开发中使用 Dubbo 遇到的坑？](#开发中使用-dubbo-遇到的坑)
  - [<font color=blue>Netty</font>](#font-colorbluenettyfont)
      - [Netty 结构](#netty-结构)
      - [Netty 零拷贝（Zero-Copy-Capable Rich Byte Buffer）](#netty-零拷贝zero-copy-capable-rich-byte-buffer)
      - [Netty 时间轮算法](#netty-时间轮算法)
